export default {
  ...
  products: {
    ...
    newServiceCategorySubtitle: 'Fill in the new category details',
    editServiceCategorySubtitle: 'Update the category details',
    serviceCategoryName: 'Category Name',
    serviceCategoryNameRequired: 'Please enter the category name',
    ...
    createServiceCategory: 'Create Category',
